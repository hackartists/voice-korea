...
pub fn DashboardCard(
    ...
    rsx! {
        div { class: "flex flex-col w-[380px] h-[420px] rounded-lg justify-between items-start bg-white m-9 p-7 border-[1px] border-[#d2d2d2]",
            div { class: "flex flex-col w-[380px]",
                ...
                div { class: "flex flex-col w-[340px]",
                    div { class: "w-full text-[#4c4c4c] font-semibold text-[30px] mb-[14px] overflow-hidden truncate",
                        {title}
                    }
                }
                div { class: "text-[20px] font-normal text-[#4c4c4c]",
                    "{update_date_label} {updated_at_string}"
                }
            }
            div { class: "flex flex-col w-full",
                div { class: "flex flex-row w-full justify-start items-center mb-[37px]",
                    img {
                    ...
                    if survey_status == SurveyStatus::Draft {
                        ...
                        div { class: "text-[#1e5eaf] font-normal text-[20px] mb-[2px]",
