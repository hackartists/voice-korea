...
pub fn DashboardRow(
    ...
    rsx! {
        div { class: "flex flex-row w-full h-[110px] mb-[10px] justify-between items-center rounded-[5px] bg-white px-[30px]",
            div { class: "flex flex-row min-w-[500px]",
                div { class: "text-[#4c4c4c] font-semibold text-[30px] mr-[50px]", {title} }
                if survey_status == SurveyStatus::Draft {
                    div { class: "flex flex-row items-center",
                        ...
                        div { class: "text-[#1e5eaf] font-normal text-[20px] mt-[1px]",
            ...
            div { class: "flex flex-row justify-start items-center",
                ...
                div { class: "flex flex-col items-center justify-center w-[110px] text-[#696969] font-normal text-[20px] mr-[50px]",
                    div { class: "flex flex-col w-full justify-center items-center mt-[25px]",
                        StatusButton {
                ...
                div { class: "flex flex-row w-[265px] items-center justify-center",
                    if survey_status == SurveyStatus::Draft {
                        div {
                            ...
                            div { class: "text-[20px] font-medium text-[#1e5eaf]", "{edit_survey}" }
                        }
                    } else {
                        div {
                            class: "flex flex-row w-[200px] h-[55px] rounded-[8px] border-solid border border-[#b0b0b0] bg-white items-center justify-center",
                            ...
                            div { class: "text-[20px] font-medium text-[#1e5eaf]", "{analysis_result}" }
                        }
                    }
                }
            }
