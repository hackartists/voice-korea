...
use crate::utils::{
    nonce_lab::NonceLabClient, time::convert_rfc3339_to_timestamp_millis,
};
use by_axum::{
    axum::{
        extract::State,
...
impl AxumState {
    pub fn router() -> Router {
        ...
        Router::new()
            .route("/", patch(Self::finalize_survey))
    ...
    async fn finalize_survey(
        ...
        for survey in surveys {
            ...
            futures.push(async move {
                ...
                let doc_id =
                    Self::create_survey_result(cli.clone(), state.nonce_lab_client.clone(), survey)
                        .await
